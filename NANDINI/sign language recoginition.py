...
train = pd.read_csv(r'C:\Users\PLANET\Downloads\sign_mnist_train.csv')

test = pd.read_csv(r'C:\Users\PLANET\Downloads\sign_mnist_test.csv')
...
print("Predicted Label: ", class_names[int(prediction[i][0])])  # Assuming prediction[i] is an array
